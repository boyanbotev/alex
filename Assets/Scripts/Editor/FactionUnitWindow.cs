...
public sealed class FactionUnitWindow : EditorWindow
{
    ...
    private void DrawStats(UnitData data)
    {
        ...
        DrawProperties(data, "cost", "maxHealth", "attackPower", "defensePower", "moveRange", "attackRange", "splashDamage", "splashRadius", "skills", "counters", "requiredPerk", "requiredPerkLevel");
    }
